...
export default function Navbar() {
  ...
  return (
    <nav className={`fixed left-0 right-0 top-0 z-50 transition-all duration-300 ${isScrolled ? "py-4" : "py-6"}`}>
      <div className="mx-auto w-full max-w-6xl px-6">
        ...
        >
          <a href="#inicio" className="text-sm font-semibold tracking-tight text-[#070707] dark:text-white">
            JOKIA
          </a>
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              ...
              className={`flex h-10 w-10 items-center justify-center rounded-xl border transition-colors ${
                isScrolled
                  ? "border-black/10 bg-[#25D366]/10 text-[#25D366] hover:bg-[#25D366]/20 dark:border-white/10 dark:bg-[#25D366]/20 dark:hover:bg-[#25D366]/30"
                  : "border-black/10 bg-white/40 text-[#25D366] hover:bg-white/60 dark:border-white/10 dark:bg-white/5 dark:hover:bg-white/10"
              }`}
            >
